...
const DynamicMapWithProperties = dynamic(() => import('./map-with-properties'), { 
  ssr: false,
  loading: () => (
...
export default function PropertiesMapModal({
  ...
  useEffect(() => {
    (window as Window & { showPropertyDetails?: (propertyId: string) => void }).showPropertyDetails = showPropertyDetailsModal;
    return () => {
      delete (window as Window & { showPropertyDetails?: (propertyId: string) => void }).showPropertyDetails;
    };
              ...
              <div className="p-2 sm:p-3 bg-muted/50 rounded-md">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs sm:text-sm font-medium">Your Location:</p>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {('distance' in property) ? `${(property as Property & { distance: number }).distance.toFixed(1)} km away` : 'Distance unknown'}
                        </p>
                      </div>
                    </Button>
                  ))}
