  ...
  const handleOpenAgentMessages = async (agent: Agent) => {
    ...
    try {
      ...
      const conversationId = await conversationService.createNewConversation(
        userData.uid, // tenant ID
        `${userData.firstName} ${userData.lastName}`, // tenant name
        agent.uid, // agent ID
      ...
      const agentDetailsMessage =
        `Hello ${agent.firstName}! I'm a tenant looking for rental properties and would love to work with you.\n\n` +
        `I'm interested in finding a rental property that meets my needs and budget. I noticed you manage ${agent.propertyCount} properties and work with ${agent.companyName}.\n\n` +
        `Could you please help me with:\n` +
        `🏠 Available rental properties in my preferred area\n` +
        `💰 Rental rates and lease terms\n` +
        `📋 Application requirements and process\n` +
        `📅 Property viewing schedules\n\n` +
        `I'm ready to move forward quickly with the right property. Please let me know what rental options you currently have available and how we can proceed.\n\n` +
        `Looking forward to hearing from you!`;

      // Navigate to messages page with the conversation and pre-populated message
      router.push(
        `/users/tenant/messages?agentId=${
          agent.uid
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Connect with experienced real estate agents to help you find and
              secure your ideal rental property
            </p>
          </div>
      ...
      <section className="py-16 bg-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Our experienced agents are here to help you discover and secure the
            perfect rental property that meets all your needs and preferences
          </p>
