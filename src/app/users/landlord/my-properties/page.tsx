      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...Array(6)].map((_, i) => (
            <Card
              key={i}
              className="hover:shadow-lg transition-shadow overflow-hidden max-w-sm"
            >
              <div className="h-48 bg-muted animate-pulse relative">
                <div className="absolute top-2 left-2 h-6 w-20 bg-background/80 animate-pulse rounded-full" />
                <div className="absolute bottom-2 right-2 h-8 w-24 bg-background/80 animate-pulse rounded" />
              </div>
          ...
          >
            ...
            <CardContent className="space-y-3 px-4 pb-4">
              ...
              <div className="flex items-center justify-between text-xs text-muted-foreground">
                ...
                <div className="text-xs">{property.datePosted}</div>
              </div>
                    ...
                    {selectedProperty.latitude &&
                      selectedProperty.longitude && (
                        <p className="text-xs text-muted-foreground mt-1">
                          Coordinates: {selectedProperty.latitude.toFixed(6)},{" "}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 p-3 bg-muted rounded-lg">
                    ...
                    <span className="font-medium">
                      Current Tenant: {selectedProperty.tenant}
                    </span>
                  </div>
                </div>
              )}
          ...
          {propertyToDelete && (
            <div className="py-4">
              <div className="p-3 bg-muted rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  ₱
                  {typeof propertyToDelete.price === "string"
                    ? propertyToDelete.price
                    : Number(propertyToDelete.price).toLocaleString()}
                  /month
                </p>
              </div>
            </div>
