...
export const metadata: Metadata = {
  ...
  description:
    "DomusEye is an AI-powered website for rental property management. Streamline property rentals, tenant management, and real estate operations with intelligent automation and modern web technology.",
  keywords: [
    "domuseye",
    "ai powered website",
  ...
  openGraph: {
    ...
    title: "DomusEye - AI Powered Rental Property Management Platform",
    description:
      "AI-powered website for rental property management. Modern, intelligent property and tenant management solution.",
    images: [
      {
  ...
  twitter: {
    ...
    description: "AI-powered website for rental property management",
